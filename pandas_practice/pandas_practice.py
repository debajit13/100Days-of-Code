{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "import pandas\n",
    "df1 = pandas.read_csv(\"temps-today.csv\")\n",
    "df1\n"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    "import pandas \n",
    "df3 = pandas.read_csv(\"supermarkets-semi-colons.txt\",\";\")\n",
    "df3"
   ]
  },
  {
   ...
   "source": [
    "import pandas \n",
    "df4 = pandas.read_excel(\"supermarkets.xlsx\",sheet_name=0)\n",
    "df4"
   ]
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "Location(735 Dolores St, San Francisco, California, 94110, (37.75780079156327, -122.4255944188067, 0.0))"
      ]
     },
     "execution_count": 24,
     "metadata": {},
